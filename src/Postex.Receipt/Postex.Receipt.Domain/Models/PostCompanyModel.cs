...
namespace Postex.Receipt.Domain.Models
{
    public class PostCompanyModel
    {
        ...
        public string? IsSafeBuy { get; set; }
        public string? PayeType { get; set; }
        public string? Eng_Kala_Price { get; set; }
        ...
        public string? CodBmValue { get; set; }
        public string? CodCostAndBmValue { get; set; }
    }

    public class BarcodePdfGenerationQuery : IRequest<byte[]>
    {
        public PostCompanyModel? postDataDto;

        public PostCompanyModel? postCompanyModel { get; set; }
    }
